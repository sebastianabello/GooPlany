...
import com.gooplanycol.gooplany.infrastructure.adapters.input.rest.model.request.EventRegistrationCreateRequest;
...
public interface EventRegistrationRestMapper {
    EventRegistration toEventRegistration(EventRegistrationCreateRequest request);
